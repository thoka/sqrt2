...
**Empfehlung für den Einstieg in die nächste Sitzung:** mit Phase 3 weitermachen (Control-Panel-Komponenten, gebunden an `configStore`/`playbackStore`).
