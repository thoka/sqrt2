...
- Dieselbe Glättung ersetzt jetzt auch den früher separaten Kernel in `getSmoothedCompactedRect()` (Abschnitt 6.2) und die zwei unabhängig voneinander existierenden `getBankTransform()`-Kopien (Haupttool UND Algorithmus-Spiel-Tool) - eine gemeinsame Lösung statt mehrerer Ad-hoc-Varianten.
